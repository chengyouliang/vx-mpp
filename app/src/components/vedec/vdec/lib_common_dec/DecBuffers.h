...
/*************************************************************************//*!
   ...
   \param[in] eFbStorage frame buffer storage mode
   \param[in] bFrameBufferCompression will the reconstruct be compressed
   \param[in] tDim dimensions of the picture
   \param[in] eChromaMode Chroma Mode
   \param[in] ePlaneId The map plane type. Must not be a pixel plane.
   \return return the size of the map component of the reconstruct
*****************************************************************************/
int AL_DecGetAllocSize_Frame_MapPlane(AL_EFbStorageMode eFbStorage, bool bFrameBufferCompression, AL_TDimension tDim, AL_EChromaMode eChromaMode, AL_EPlaneId ePlaneId);
