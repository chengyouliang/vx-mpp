...
struct MppBufferImpl_t {
    ...
    OMX_U32              log_runtime_en;
    OMX_U32              log_history_en;
    OMX_U32              group_id;
    OMX_S32              buffer_id;
    MppBufferMode       mode;
    MppBufferType       type;
...
struct MppBufferGroupImpl_t {
    ...
    OMX_U32              clear_on_exit;
    OMX_U32              dump_on_exit;
...
extern OMX_U32 mpp_buffer_debug;
