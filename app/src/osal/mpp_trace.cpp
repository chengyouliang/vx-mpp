...
public:
    ...
    void trace_async_begin(const char* name, OMX_S32 cookie);
    void trace_async_end(const char* name, OMX_S32 cookie);
    void trace_int32(const char* name, OMX_S32 val);
    void trace_int64(const char* name, OMX_S64 val);
};
...
void MppTraceService::trace_async_begin(const char* name, OMX_S32 cookie)
{
    if (mTraceFd < 0)
        return;
...
void MppTraceService::trace_async_end(const char* name, OMX_S32 cookie)
{
    if (mTraceFd < 0)
        return;
...
void MppTraceService::trace_int32(const char* name, OMX_S32 value)
{
    if (mTraceFd < 0)
        return;
...
void MppTraceService::trace_int64(const char* name, OMX_S64 value)
{
    if (mTraceFd < 0)
        return;
...
void mpp_trace_async_begin(const char* name, OMX_S32 cookie)
{
    MppTraceService::get_inst()->trace_async_begin(name, cookie);
}

void mpp_trace_async_end(const char* name, OMX_S32 cookie)
{
    MppTraceService::get_inst()->trace_async_end(name, cookie);
}

void mpp_trace_int32(const char* name, OMX_S32 value)
{
    MppTraceService::get_inst()->trace_int32(name, value);
}

void mpp_trace_int64(const char* name, OMX_S64 value)
{
