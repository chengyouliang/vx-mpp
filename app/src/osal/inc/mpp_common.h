...
#define MPP_RB16(x)  ((((const OMX_U8*)(x))[0] << 8) | ((const OMX_U8*)(x))[1])
#define MPP_WB16(p, d) do { \
        ((OMX_U8*)(p))[1] = (d); \
        ((OMX_U8*)(p))[0] = (d)>>8; } while(0)

#define MPP_RL16(x)  ((((const OMX_U8*)(x))[1] << 8) | \
                     ((const OMX_U8*)(x))[0])
#define MPP_WL16(p, d) do { \
        ((OMX_U8*)(p))[0] = (d); \
        ((OMX_U8*)(p))[1] = (d)>>8; } while(0)

#define MPP_RB32(x)  ((((const OMX_U8*)(x))[0] << 24) | \
                     (((const OMX_U8*)(x))[1] << 16) | \
                     (((const OMX_U8*)(x))[2] <<  8) | \
                     ((const OMX_U8*)(x))[3])
#define MPP_WB32(p, d) do { \
        ...
        ((OMX_U8*)(p))[2] = (d)>>8; \
        ((OMX_U8*)(p))[1] = (d)>>16; \
        ((OMX_U8*)(p))[0] = (d)>>24; } while(0)

#define MPP_RL32(x) ((((const OMX_U8*)(x))[3] << 24) | \
                    (((const OMX_U8*)(x))[2] << 16) | \
                    (((const OMX_U8*)(x))[1] <<  8) | \
                    ((const OMX_U8*)(x))[0])
#define MPP_WL32(p, d) do { \
        ...
        ((OMX_U8*)(p))[1] = (d)>>8; \
        ((OMX_U8*)(p))[2] = (d)>>16; \
        ((OMX_U8*)(p))[3] = (d)>>24; } while(0)

#define MPP_RB64(x)  (((OMX_U64)((const OMX_U8*)(x))[0] << 56) | \
                     ((OMX_U64)((const OMX_U8*)(x))[1] << 48) | \
                     ((OMX_U64)((const OMX_U8*)(x))[2] << 40) | \
                     ((OMX_U64)((const OMX_U8*)(x))[3] << 32) | \
                     ((OMX_U64)((const OMX_U8*)(x))[4] << 24) | \
                     ((OMX_U64)((const OMX_U8*)(x))[5] << 16) | \
                     ((OMX_U64)((const OMX_U8*)(x))[6] <<  8) | \
                     (OMX_U64)((const OMX_U8*)(x))[7])
#define MPP_WB64(p, d) do { \
        ...
        ((OMX_U8*)(p))[2] = (d)>>40; \
        ((OMX_U8*)(p))[1] = (d)>>48; \
        ((OMX_U8*)(p))[0] = (d)>>56; } while(0)

#define MPP_RL64(x)  (((OMX_U64)((const OMX_U8*)(x))[7] << 56) | \
                     ((OMX_U64)((const OMX_U8*)(x))[6] << 48) | \
                     ((OMX_U64)((const OMX_U8*)(x))[5] << 40) | \
                     ((OMX_U64)((const OMX_U8*)(x))[4] << 32) | \
                     ((OMX_U64)((const OMX_U8*)(x))[3] << 24) | \
                     ((OMX_U64)((const OMX_U8*)(x))[2] << 16) | \
                     ((OMX_U64)((const OMX_U8*)(x))[1] <<  8) | \
                     (OMX_U64)((const OMX_U8*)(x))[0])
#define MPP_WL64(p, d) do { \
        ...
        ((OMX_U8*)(p))[5] = (d)>>40; \
        ((OMX_U8*)(p))[6] = (d)>>48; \
        ((OMX_U8*)(p))[7] = (d)>>56; } while(0)

#define MPP_RB24(x)  ((((const OMX_U8*)(x))[0] << 16) | \
                     (((const OMX_U8*)(x))[1] <<  8) | \
                     ((const OMX_U8*)(x))[2])
#define MPP_WB24(p, d) do { \
        ((OMX_U8*)(p))[2] = (d); \
        ((OMX_U8*)(p))[1] = (d)>>8; \
        ((OMX_U8*)(p))[0] = (d)>>16; } while(0)

#define MPP_RL24(x)  ((((const OMX_U8*)(x))[2] << 16) | \
                     (((const OMX_U8*)(x))[1] <<  8) | \
                     ((const OMX_U8*)(x))[0])
...
static __inline OMX_S32 mpp_ceil_log2(OMX_S32 x)
{
    return mpp_log2((x - 1) << 1);
}

static __inline OMX_S32 mpp_clip(OMX_S32 a, OMX_S32 amin, OMX_S32 amax)
{
...
static __inline OMX_U32 mpp_is_32bit()
{
