...
MPP_RET mpp_dev_init(MppDev *ctx, MppClientType type)
{
    ...
    *ctx = NULL;
    ...
    OMX_U32 codec_type = mpp_get_vcodec_type();
...
MPP_RET mpp_dev_ioctl(MppDev ctx, OMX_S32 cmd, void *param)
{
    if (NULL == ctx) {
        mpp_err_f("found NULL input ctx\n");
        return MPP_ERR_NULL_PTR;
...
MPP_RET mpp_dev_set_reg_offset(MppDev dev, OMX_S32 index, OMX_U32 offset)
{
